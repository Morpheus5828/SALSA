...
def extract_features(sea_ocean, other, repo):
    ...
    for img in sea_ocean:
        dataset_with_grey_filter.append(cv2.imread("../dataset/sea_ocean/" + repo + "/" + img, cv2.COLOR_BGR2GRAY))
        dataset_no_filter.append(cv2.imread("../dataset/sea_ocean/" + repo + "/" + img))
        dataset_labels.append(1)
    for img in other:
        dataset_with_grey_filter.append(cv2.imread("../dataset/other/" + repo + "/" + img, cv2.COLOR_BGR2GRAY))
